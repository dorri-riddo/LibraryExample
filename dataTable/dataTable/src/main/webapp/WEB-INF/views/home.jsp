...
<table id="example" class="table table-striped table-bordered" style="width:100%; table-layout:fixed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Accountantadsffffffffffffffffffffffffffffffffdsf asdfsadfsadf dsaf asdf dsaf dsafh sakjdfh dsakjfhkfhlakjdshf kjdsahflkjadshfkjdfsahkljdsahf lkjdsahf ksajdhf dsahkjf jfdsaf dsafdsafsadf</td>
                <td>Tokyo</td>
                <td>63</td>
                <td>2011/07/25</td>
                <td>$170,750</td>
...
$(document).ready(function() {
   ...
   $('#example tfoot th').each( function () {
	...
	var table = $('#example').DataTable({
		destroy: true, //초기화 설정 
		colReorder: true, //헤더이동
 		serverSide: false,
		lengthMenu : [10, 20, 30], //한 페이지에 보여줄 항목 수 설정
		scrollX: true, // 스크롤 생성
		scrollY: "200px",
		scrollCollapse: true,
